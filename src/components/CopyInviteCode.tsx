...
const CopyInviteCode: React.FC<Props> = ({ code, onCopy, theme }) => {
  return (
    <div
      className={`h-[74px] w-[344px] flex items-center justify-between 
        rounded-[15px] border-[2px] border-laborit-dark-gray 
        dark:border-white p-4 bg-laborit-input-edit-background
        dark:bg-laborit-dark-gray`}
    >
